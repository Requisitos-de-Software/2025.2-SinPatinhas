...
| ID        | Categoria      | Item | Artefato está conforme? |
|-----------|----------------|------|--------------|
| #V020 | Perfil de Usuário | [O perfil de usuário possui registro dos objetivos dos usuários?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V021 | Perfil de Usuário | [O perfil de usuário descreve características (faixa etária, nível de instrução) dos usuários do sistema?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V022 | Perfil de Usuário | [As características analisadas para o perfil do usuário são relevantes para o desenvolvimento do sistema projetado?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V023 | Perfil de Usuário | [Foram coletados dados sobre as características dos usuários através de estudo? (entrevistas, questionários)](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V024 | Perfil de Usuário | [Os dados coletados foram agregados em grupos de acordo com os valores observados?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) (faixa etária 10-15 anos) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) | 
| #V025 | Perfil de Usuário | [Foram traçados perfis de usuário considerando as faixas de dados agregados?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V026 | Perfil de Usuário | [Foi calculada a proporção de usuários que se encaixam em cada perfil?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V027 | Perfil de Usuário | [O perfil de usuário foi elaborado dentro de um processo iterativo?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V028 | Perfil de Usuário | [As características foram priorizadas de acordo com a sua relevância para o produto e projeto? (dados sobre o usuário, seu conhecimento sobre o produto)](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V029 | Perfil de Usuário | [Os usuários foram categorizados em grupos?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V030 | Perfil de Usuário | [Os grupos correspondem à distribuição dos usuários nas faixas de dados agregados?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V031 | Perfil de Usuário | [O perfil de usuário possui nível de experiência do usuário?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V032 | Perfil de Usuário | [O perfil de usuário possui tarefas que deverão ser realizadas no sistema?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V033 | Perfil de Usuário | [O conhecimento do usuário sobre o domínio do produto está especificado?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V034 | Perfil de Usuário | [A experiência profissional e o cargo do usuário estão detalhados?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
| #V035 | Perfil de Usuário | [As atitudes e valores do usuário em relação à tecnologia foram considerados?](../elicitacao/listas_verificacao/lista_verificacao_perfil_usuario.md) | [Conforme](../elicitacao/perfis_usuarios/perfis-de-usuario.md) |
