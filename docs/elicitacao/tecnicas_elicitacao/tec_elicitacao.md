...
- ### Cronograma de Elicitação
  ...
  |Entrevista|26/09/2025|30/09/2025|Letícia| Reagendado devido disponibilidade do entrevistado|
...
**Entrevista 02**
      ...
      <iframe width="100%" height="600" 
      src="https://youtu.be/78vAABLNU_4" 
      title="YouTube video player" 
      frameborder="0" 
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
      allowfullscreen>
  ...
  **Nome: Gustavo**
   ...
   **Perfil**
      Jovem, estudante, 22 anos, estudante de Ciências Biológicas na Universidade de Brasília, estagiário em laboratório de micologia. Atualmente tem cães, já teve peixes e aves.
      
  **Comportamentos**
      Organiza os cuidados com os animais (vacinação, consultas, medicação) anotando as informações, o que requer tempo e dedicação 

      Todos os animais são castrados e recebem vacinações em dia 

      Consultas veterinárias são constantes devido a problemas de saúde relacionados à raça/espécie de seus animais [00:41].

      Não utilizou nenhum aplicativo ou sistema para gerenciar os cuidados com os animais 

**Necessidades (Objetivos)**

      Facilidade na gestão do tempo para registrar informações sobre vacinas e medicamentos 

      Um sistema nacional para cadastrar e identificar animais que ofereça facilidade na recuperação de animais perdidos/abandonados 

      Facilidade no processo de adoção de animais abandonados 

      Facilidade para acessar informações sobre vacinação e castração pública 

      Um "cartão do SUS digital" para animais, onde todas as informações de saúde e vacinação estivessem digitalizadas e acessíveis via aplicativo 

      Praticidade no dia a dia, eliminando a necessidade de documentos físicos e agendas, centralizando tudo em um aplicativo 

      Aplicativos/sistemas com comunicação clara e fácil de entender 

      Acesso ao sistema via celular (preferencialmente) e computador

      Recursos automáticos como alertas de vacinação e lembretes de medicação

      Integração com clínicas, ONGs e pet shops para facilitar o acesso às informações 

      Funcionalidade de adoção de animais 
  ...
  **Requisitos Funcionais**
      ...
      RF01: O sistema deve permitir a busca e recuperação de animais perdidos ou abandonados.
        ...
        Fonte: (02:02) - "Esperaria facilidade na recuperação de animais que estejam abandonados ou perdidos, né?"

        RF02: O sistema deve funcionar como um prontuário digital, centralizando o histórico de saúde e vacinação do animal.

        Fonte: (02:51) - "...algo que parecesse com o cartão do SUS digital que a gente tem. Então você ir lá vacinar e tudo já está digitalizado ali."

        RF03: O sistema deve incluir uma funcionalidade para facilitar a adoção de animais.

        Fonte: (04:34) - "...a de adoção. Um sistema de adoção acho que seria muito interessante."

        RF04: O sistema deve enviar notificações automáticas para vacinas e lembretes para horários de medicação.

        Fonte: (04:10) - "Alertas de vacinação... Remédios também, tipo, um animal que tem que tomar remédio de tal e tal horas, a próxima hora, o aplicativo avisa."
        ...
        Fonte: (02:26) - "Nome, idade, tipo sanguíneo, peso, altura, raça, espécie, claro... caso o animal possua, seja animal com dono, endereço."

  **Requisitos Não Funcionais**

     RNF01 (Usabilidade): O sistema deve ser claro e fácil de entender, permitindo que o usuário saiba exatamente o que fazer.

      Fonte: (03:52) - "Facilidade na comunicação do aplicativo. Eu olho o aplicativo e sei exatamente tudo que eu tenho que fazer. Ele é muito claro, é muito fácil de entender."
      ...
      Fonte: (04:02) - "Ambos (celular e computador), porém, com maior lado pelo celular porque todo mundo tem o celular hoje em dia..."

      RNF03 (Integração): O sistema deve permitir a integração com clínicas, ONGs e pet shops para facilitar o acesso à informação.

      Fonte: (04:27) - A resposta "Com certeza" confirma a necessidade de que clínicas, ONGs e pet shops tenham acesso integrado ao sistema.

      RNF04 (Utilidade): O sistema deve ser prático e substituir com eficiência o uso de documentos e agendas físicas.

      Fonte: (03:10) - "O sistema torna tudo mais prático, né? Você não precisa ir atrás de documento, você não precisa separar tudo em agendas. Tudo no aplicativo só seria muito mais fácil."
- ### ...
  ...
...
| 1.4   | 01/10/2025 | Adição da entrevista com Gustavo e requisitos  |  Letícia | Pedro e Antonio     |
