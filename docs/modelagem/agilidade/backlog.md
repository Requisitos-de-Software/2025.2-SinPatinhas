...
| Letícia Paiva    | [Modelagem do Backlog - BL001 — Sistema de Adoção de Animais (RFNI016) e BL002 — Alertas e Notificações Automáticas (RFNI017)](/modelagem/gravacoes/leticia/backlog.md) |
...
|--------------------|--------------------|----------------|---------------------------|-------------|------------------|---------------------|
| BLXXX | [Nome da funcionalidade ou requisito] | [Breve descrição do item, destacando seu objetivo e valor de negócio] | [Must have / Should have / Could have / Won’t have] | [Não iniciado / Em andamento / Concluído] | [Nome do responsável] | [Código do requisito correspondente, se houver] |
...
|------------------------|----------------------|-----------------------------|
| **Letícia Paiva**   | 50%                 | Autor da página de backlog  |
| **Antonio Carvalho**   | 50%                 | Autor da página de backlog |
