...
## Listas de Verificação do Projeto SinPatinhas

| Lista | Autoria | Acesso |
|------|------|------|
| Diagrama de Caso de Uso | **Letícia Paiva** | [Ir para lista](#caso-uso) |
| Especificação Suplementar | **Letícia Paiva** | [Ir para lista](#especificacao-suplementar) |
| Backlog | **Heloísa Santos** | [Ir para lista](#backlog) |
| NFR Framework | **Heloísa Santos** | [Ir para lista](#nfr-framework) |



---
# Lista de Verificação – Especificação Suplementar <span id="especificacao-suplementar"></span>
...
## Lista de Verificação - Backlog <span id="backlog"></span>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>006</td>
      <td>As estimativas de esforço foram registradas em Story Points e são atualizadas conforme o andamento da Sprint?</td>
      <td>Antonio</td>
...
## Lista de Verificação - NFR Framework <span id="nfr-framework"></span>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>010</td>
      <td>As relações de contribuição entre softgoals estão explicitadas (Make, Help, Hurt, Break etc.)?</td>
      <td>Antonio</td>
...
## Lista de Verificação – Diagrama de Caso de Uso <span id="caso-uso"></span>
...
| 1.1 | 12/10/2025 | edição da pagina listas de verificação | Letícia Paiva | Antonio |
